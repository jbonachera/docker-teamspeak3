...
ENV URL=http://dl.4players.de/ts/releases/3.0.11.4/teamspeak3-server_linux-amd64-3.0.11.4.tar.gz
RUN curl -sL $URL -o /opt/ts3.tgz && \
    ...
    ln -sf /var/lib/ts3/ts3server.sqlitedb /opt/teamspeak3-server_linux-amd64/ts3server.sqlitedb && \
